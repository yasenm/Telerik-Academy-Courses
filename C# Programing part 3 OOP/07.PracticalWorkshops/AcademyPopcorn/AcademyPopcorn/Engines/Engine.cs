...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        // Exercise 02 part adding the sleep parameter for the Thread
        private int ThreadSleeper;

        public Engine(IRenderer renderer, IUserInterface userInterface, int threadSleeper = 50)
        {
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            this.allObjects.Remove(this.playerRacket);  // ----> Solved
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.ThreadSleeper);
