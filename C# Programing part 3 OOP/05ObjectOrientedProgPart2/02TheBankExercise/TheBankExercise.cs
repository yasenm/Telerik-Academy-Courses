// Exercise 02 : A bank holds different types of accounts for its customers:
// deposit accounts, loan accounts and mortgage accounts. Customers could be 
...
namespace _02TheBankExercise
{
    using System;
    using System.Collections.Generic;
    using System.Linq;

    class TheBankExercise
    {
        static void Main()
        {
            Company peshoInc = new Company("yasen inc.");
            DepositeAccount peshoDeposite = new DepositeAccount(peshoInc, 1000, 4);
            Individual ivan = new Individual("Lubchica");
            DepositeAccount ivanDeposite = new DepositeAccount(ivan,5000,12);
